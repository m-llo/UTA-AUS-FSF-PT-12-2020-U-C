...
describe("Child", () => {
  ...
  // outlines what should happen and gives a positive test cast "happy path"
  describe("Initialization", () => {
    it("should create an object with a name and age if provided valid arguments", () => {
      const child = new Child("Sarah", 3);

      // TODO: Add a comment describing the purpose of the following statements
      // This outlines what is expected to happen at the end in the new object
    ...
    it("should throw an error if provided no arguments", () => {
      ...
      // arrange steps decribes what the call back function is supposed to do in the event of an error
      const cb = () => new Child();

      // TODO: Add a comment describing the purpose of the following statement
      // this is what the call back function is expected to throw an error
      expect(cb).toThrow();
    });
